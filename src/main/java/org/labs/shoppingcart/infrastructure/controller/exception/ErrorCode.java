...
public enum ErrorCode {
    ...
    HTTP_MEDIA_TYPE_NOT_ACCEPTABLE("PACKT-0004", "Requested 'Accept' header value is not supported." +
    ...
    APPLICATION_VALIDATION_ERROR("PACKT-0007", "The system has found some inconsistencies in the transaction," +
            " verify the information entered and try the transaction again.");
